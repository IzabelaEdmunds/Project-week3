...
### The script requires "Reshape Grouped Data" package “reshape2” which is part of this script and can be run from point 1 for different environments than Windows.

The scrip will result in two text files being written:
